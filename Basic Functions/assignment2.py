...
def convertToBlackAndWhite(image):
    ...
    """
    # WRITE YOUR CODE HERE.
    res = np.where(image > 128, 255, 0)
    #cv2.imwrite('blackAndWhiteOutput.png',res)	
    return res
    # END OF FUNCTION.
...
def averageTwoImages(image1, image2):
    ...
    #cv2.imwrite('averageTwoOutput.png',result)   
    return result
    # END OF FUNCTION.
...
def flipHorizontal(image):
    ...
    # WRITE YOUR CODE HERE.
    res = np.fliplr(image)
    #cv2.imwrite('flipOutput.png',res)  
    return res
    # END OF FUNCTION.